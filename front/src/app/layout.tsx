...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "e-commerce website design london",
    "shopify developers london",
    "wordpress developers london",
    "next.js developers london",
    "react developers london",
    "full stack developers london",
    "front end developers london",
    "affordable web development london",
    "cheap web design london",
    "professional web design services london",
    "london digital agency",
    "digital agency london",
    "startup web development london",
    "small business website london",
    "enterprise web solutions london",
    "seo friendly web design london",
    "website redesign london",
    "website development services london",
    "bespoke web design london",
    "ecommerce web developers london",
    "web design agency near me",
    "website designers london",
    "central london web developers",
    "east london web development",
    "web development shoreditch",
    "web development city of london",
