...
const WebDevelopmentPage: React.FC = () => {
  ...
  const services: Service[] = [
    {
      ...
      description:
        "Bespoke web applications built with modern frameworks like React, Next.js, and Node.js for optimal performance and scalability.",
      features: [
        "React & Next.js",
        "Node.js Backend",
        "API Development",
    ...
    },
    {
      ...
      description:
        "Mobile-first approach ensuring your website looks perfect and functions flawlessly across all devices and screen sizes.",
      features: [
        "Mobile-First Design",
    ...
    },
    {
      ...
      description:
        "Complete online store solutions with secure payment processing, inventory management, and conversion optimization.",
      features: [
        "Shopify & WooCommerce",
        "Payment Integration",
    ...
    },
    {
      ...
      description:
        "Websites built with search engine optimization in mind, featuring clean code, fast loading times, and proper meta structures.",
      features: [
        "Technical SEO",
    ...
    },
    {
      ...
      description:
        "Enterprise-grade security implementation with SSL certificates, data encryption, and protection against common vulnerabilities.",
      features: [
        "SSL Implementation",
        "Data Encryption",
        "Security Audits",
    ...
    },
    {
      ...
      description:
        "Scalable cloud hosting solutions with automated backups, CDN integration, and 99.9% uptime guarantee.",
      features: [
        "AWS & Azure",
        "CDN Integration",
        "Auto Scaling",
  ...
  const websitePricingPlans: PricingPlan[] = [
    {
      name: "Basic",
      price: "£500",
  ...
  const processSteps: ProcessStep[] = [
    {
      ...
      description:
        "We analyze your business requirements, target audience, and technical specifications to create a comprehensive project roadmap.",
      icon: Target,
      duration: "1-2 weeks",
    },
    {
      ...
      description:
        "Our UI/UX team creates wireframes and designs that prioritize user experience and align with your brand identity.",
      icon: Palette,
      duration: "2-3 weeks",
    },
    {
      ...
      title: "Development",
      description:
        "Clean, scalable code development using modern frameworks and best practices for optimal performance and maintainability.",
      icon: Code2,
      duration: "4-8 weeks",
    },
    {
      ...
      title: "Testing & QA",
      description:
        "Comprehensive testing across devices and browsers to ensure bug-free functionality and optimal user experience.",
      icon: Shield,
      duration: "1-2 weeks",
    },
    {
      ...
      description:
        "Smooth deployment to production with ongoing maintenance, updates, and technical support for continuous optimization.",
      icon: Rocket,
      duration: "Ongoing",
    },
  ];
  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        "Project timelines vary based on complexity. A simple business website takes 2-4 weeks, while complex web applications can take 8-16 weeks. We provide detailed timelines during the planning phase.",
    },
    {
      question: "Do you provide ongoing support after launch?",
      answer:
        "Yes, we offer comprehensive post-launch support including hosting, maintenance, security updates, and feature enhancements to ensure your website continues to perform optimally.",
    },
    {
      question: "Will my website be mobile-friendly and SEO optimized?",
      answer:
        "Absolutely. All our websites are built with a mobile-first approach and include technical SEO optimization, fast loading times, proper meta structures, and schema markup for better search engine visibility.",
    },
    {
      question: "What technologies do you use for web development?",
      answer:
        "We use modern technologies including React, Next.js, Node.js, Python, and cloud platforms like AWS. Our tech stack is chosen based on your project requirements for optimal performance and scalability.",
    },
  ];
  ...
  return (
    <>
      <Head>
        <title>
          Professional Web Development Services | Custom Web Applications
        </title>
        <meta
          name="description"
          content="Expert web development services including custom web applications, responsive design, e-commerce solutions, and SEO optimization. Mobile-first approach with modern frameworks."
        />
        <meta
          name="keywords"
          content="web development, custom websites, React development, Next.js, responsive design, e-commerce development"
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link
          rel="canonical"
          href="https://viorixdigital.com/services/web-development"
        />
      </Head>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
            ...
            >
              ...
              <p className="text-xl sm:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
                Custom web development solutions that drive business growth.
                From responsive websites to complex web applications, we build
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2
                id="services-heading"
                className="text-3xl sm:text-4xl font-bold text-[#1B365D] mb-4"
              >
                Comprehensive Web Development Services
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We offer end-to-end web development solutions tailored to your
                business needs, from simple websites to complex enterprise
                applications.
              </p>
            </motion.div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
                ...
                modern, scalable, and maintainable web applications that exceed
                expectations.
              </p>
            </motion.div>
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center justify-center mb-6">
                        <div className="relative w-20 h-20 p-4 rounded-2xl bg-white/10 backdrop-blur-sm group-hover:scale-110 transition-all duration-500 border border-white/20">
                          <div
                            className={`absolute inset-0 bg-gradient-to-r ${tech.color} opacity-20 rounded-2xl`}
                          />
                          <Image
                            src={tech.image}
                            alt={`${tech.name} logo`}
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Transparent pricing with all-inclusive website design,
              ...
              {websitePricingPlans.map((plan) => (
                <div
                  ...
                  className={`relative bg-white rounded-2xl shadow-lg border transition-all duration-300 hover:shadow-xl hover:scale-105 ${
                    plan.highlighted
                      ? "border-[#00BFFF] scale-105"
                      : "border-gray-200"
                  }`}
                >
                  {plan.highlighted && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                      <div className="bg-[#00BFFF] text-white px-6 py-2 rounded-full text-sm font-bold shadow">
                        Most Popular
                      </div>
                    </div>
                  )}
                  ...
                  <div className="p-8 flex flex-col h-full">
                    ...
                    <div className="text-center mb-6">
                      <div
                        className={`flex items-center justify-center w-16 h-16 rounded-full mx-auto mb-4 shadow-lg ${
                          plan.name === "Basic"
                            ? "bg-gradient-to-r from-gray-200 to-gray-300"
                            : plan.name === "Professional"
                            ? "bg-gradient-to-r from-[#00BFFF] to-[#1B365D]"
                            : "bg-gradient-to-r from-[#1B365D] to-[#00BFFF]"
                        }`}
                      >
                        {plan.name === "Basic" && (
                          <Laptop className="w-8 h-8 text-[#1B365D]" />
                        )}
                        {plan.name === "Professional" && (
                          <Layout className="w-8 h-8 text-white" />
                        )}
                        {plan.name === "E-commerce & CMS" && (
                      ...
                      <div className="flex items-baseline justify-center">
                        <span className="text-4xl sm:text-5xl font-black text-[#1B365D]">
                          {plan.price}
                        </span>
                      </div>
                    </div>
                    ...
                    <ul className="space-y-4 flex-1">
                      {plan.features.map((feature) => (
                        <li key={feature} className="flex items-start">
                          <Check className="w-5 h-5 text-[#00BFFF] mr-3 mt-0.5 flex-shrink-0" />
            ...
            <div className="text-center mt-12">
              ...
              <Link href="/contact">
                <button className="inline-flex items-center cursor-pointer px-8 py-4 bg-[#00BFFF] text-white font-semibold rounded-full shadow-lg hover:bg-[#1B365D] transition-all duration-300">
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                A proven methodology that ensures project success from concept
          ...
          <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                Let&apos;s discuss your requirements and create a custom web
