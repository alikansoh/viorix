...
const Services = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <Star className="w-3 h-3 sm:w-4 sm:h-4 text-[#00BFFF]" />
            <span className="text-xs sm:text-sm">OUR PREMIUM SERVICES</span>
            <Zap className="w-3 h-3 sm:w-4 sm:h-4 text-[#00BFFF]" />
          </motion.div>
        ...
        >
          {Object.keys(tabContent).map((tab) => {
            ...
            return (
              ...
              >
                <TabIcon className={`w-4 h-4 sm:w-5 sm:h-5 ${activeTab === tab ? 'text-white' : 'text-[#00BFFF]'}`} />
        ...
        {/* Enhanced Content Card - Mobile Responsive */}
        <motion.div
        ...
        >
          <div className="flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row">
              {/* Text Section - Enhanced for Mobile */}
              <AnimatePresence mode="wait">
                <motion.div
                  key={activeTab}
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                      <div className="p-2 sm:p-3 bg-gradient-to-r from-[#00BFFF]/10 to-[#1B365D]/10 rounded-xl sm:rounded-2xl">
                        <active.icon className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-[#1B365D]" />
                      </div>
                    ...
                    <h3 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-black text-gray-900 leading-tight">
                      {active.subheading}
                    </h3>
                    ...
                    <div className="mt-6 sm:mt-8 pt-4 sm:pt-6">
                      <motion.button
                        className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-[#00BFFF] to-[#1B365D] text-white font-semibold rounded-full hover:shadow-lg transition-all duration-300 w-full sm:w-auto"
        ...
        {/* Enhanced Service Cards Grid - Mobile Responsive */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                  ...
                  <h4 className="font-bold text-base sm:text-lg text-gray-900">{key}</h4>
                </div>
